...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Kehadiran Mahasiswa UNSAP</title>
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index.html" class="d-block">
                                                    <img src="{{ asset('') }}/images/unsap.png" alt="Universitas Sebelas April Sumedang" height="40">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Sign in with your student or teacher account.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form action="{{ route('login') }}" method="POST">
                                                ...
                                                <div class="mt-4 text-center">
                                                    ...
                                                    <div>
                                                        <button type="button"
                                                            class="btn btn-outline-primary w-100 mb-3 d-flex justify-content-center align-items-center gap-2"><i
                                                                class="ri-google-fill fs-16"></i>
                                                            @unsap.ac.id / @student.unsap.ac.id</button>
                                                        <button type="button"
                                                            class="btn btn-outline-primary w-100 mb-3 d-flex justify-content-center align-items-center gap-2"><i
                                                                class="ri-google-fill fs-16"></i>
                                                            NIM@mhs.stimk-sumedang.ac.id</button>
                                                        <button type="button"
                                                            class="btn btn-outline-primary w-100 d-flex justify-content-center align-items-center gap-2"><i
                                                                class="ri-google-fill fs-16"></i>
                                                            Nama@staisebelasapril.ac.id</button>
